  ...
  return (
    <footer className="footer">
          ...
          <div className="footer-grid">
            <div className="footer-brand">
              <div className="footer-logo">
                ...
                <span className="footer-logo-text">Book Bazaar</span>
              </div>
              <p className="footer-description">
                Your trusted online bookstore. Discover thousands of books across every genre, from bestsellers to hidden gems.
              </p>
      ...
      <div className="footer-bottom">
        <div className="container">
          <p>© {new Date().getFullYear()} Book Bazaar. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
